...
/**
 * schema
 * Order ID	Order type	Model Name	SKU Number	Model Version	Plant Code	Order Status
 * OrderId: string
 * OrderType: enum
 * ModelName:
 * SkuNumber:
 * ModelVersion
 * PlantCode
 * OrderStatus: enum (CREATED | IN_PROGRESS | DELIVERED | IN_VERIFICATION | APPROVED)
 */
